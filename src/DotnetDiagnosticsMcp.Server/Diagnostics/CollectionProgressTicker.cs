...
/// emissions, anchored on the request's <c>_meta.progressToken</c>. Stage A of RFC 0002
/// §7.3 item 7 / issue #211 — the MCP-native replacement for the legacy
/// <c>runAsJob=true</c> + <c>get_collection_status</c> polling loop.
/// </summary>
/// <remarks>
/// <para>
